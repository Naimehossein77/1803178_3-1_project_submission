...
<body>
  ...
  <div class="login-wrap d-flex align-items-center flex-wrap justify-content-center">
    <div class="container">
      @include('backend.customer.partial.laravelError')
          ...
          <div class="login-box bg-white box-shadow border-radius-10">
            ...
            <form action="{{ route('customer.password.update') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="input-group custom">
                <input type="email" class="form-control form-control-lg" placeholder="Email" name="email" value="{{ $user->email }}" readonly>
              ...
              <div class="input-group custom">
                <input type="password" class="form-control form-control-lg" placeholder="New Password" name="password" data-validation="required">
              ...
              <div class="input-group custom">
                <input type="password" class="form-control form-control-lg" placeholder="Confirm New Password" name="password_confirmation" data-validation="required">
                <div class="input-group-append custom">
                  <span class="input-group-text"><i class="dw dw-padlock1"></i></span>
                </div>
              </div>

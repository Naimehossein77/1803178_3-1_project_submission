...
<body class="login-page">
  <div class="login-header box-shadow">
    <div class="container-fluid d-flex justify-content-between align-items-center">
      <h4 class="login-person-text">Customer Login</h4>
          ...
          <div class="login-box bg-white box-shadow border-radius-10">
            <form method="POST" action="{{ route('customer.login') }}" enctype="multipart/form-data">
              ...
              <div class="input-group custom">
                <input type="text" class="form-control form-control-lg" placeholder="admin@example.com" name="email" value="naimehossein77@gmail.com">
              ...
              <div class="row pb-30">
                <div class="col-12">
                  <div class="forgot-password"><a href="{{ route('customer.password.request') }}" class="text-danger">Forgot Password</a></div>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-12">
                  <div class="input-group mb-0">
                    ...
                    <a href="{{ route('customer.register') }}" class="p-2 ml-3 text-info font-weight-bold"><u>or, Create an account to start right away!</u></a>
                  </div>
                </div>
              </div>
            </form>
